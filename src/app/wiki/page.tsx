...
const GAME_MODE_INFO: {
...
}[] = [
  {
    ...
    description:
      "Players compete to control objective zones placed across the battlefield. Victory points are scored at the end of each round based on zones controlled.",
    objectiveCount: "3 objective zones",
    special: "Standard control-based scoring each round",
  },
  {
    name: "A Clash of Kings",
    description:
      "A tug-of-war style game mode where players fight over a central objective. Points are scored by holding the center and pushing the advantage.",
    objectiveCount: "Central + 2 flanking objectives",
    special: "Bonus VP for controlling the center",
  },
  {
    name: "A Storm of Swords",
    description:
      "An aggressive game mode focused on destroying enemy units. Players score points both from objectives and from the total cost of enemy units eliminated.",
    objectiveCount: "2 objectives per side",
    special: "Bonus VP for destroying enemy units",
  },
  {
    name: "A Feast for Crows",
    description:
      "A secretive game mode where each player selects hidden objectives at the start. Points are scored by completing these secret missions during the game.",
    objectiveCount: "Variable (hidden selection)",
    special: "Secret objective cards are selected at game start",
  },
  {
    name: "A Dance with Dragons",
    description:
      "A dynamic game mode where objectives shift positions or change value throughout the game, forcing constant adaptation and redeployment.",
    objectiveCount: "3 shifting objectives",
    special: "Objectives move or change value each round",
  },
];
  ...
  return (
    <div className="min-h-screen bg-stone-900 p-4 sm:p-6 lg:p-8">
      <div className="mx-auto max-w-5xl">
        <PageHeader
          title="Wiki"
          description="Browse units, attachments, NCUs, tactics cards, and game modes."
        />
        ...
        {/* Search + Faction Filter (not for game modes) */}
        {activeTab !== "gamemodes" && (
        ...
        {activeTab === "gamemodes" && (
          <div className="space-y-4">
            <p className="text-xs text-stone-500 mb-3">
              {GAME_MODE_INFO.length} game modes
            </p>
            {GAME_MODE_INFO.map((gm) => (
              <Card key={gm.name} padding="md">
