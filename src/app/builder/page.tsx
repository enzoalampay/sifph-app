...
import { useArmyBuilder } from "@/hooks/useArmyBuilder";
...
export default function BuilderPage() {
  ...
  const entityStorage = useEntityStorage<ArmyList>(STORAGE_KEYS.ARMY_LISTS);
          ...
          <section className="mb-10">
            ...
            {entityStorage.items.length === 0 ? (
              <EmptyState
                ...
                description="Create a new army list below to get started."
              />
            ) : (
